...
export default function App() {
  ...
  const handleNext = async () => {
    ...
    try {
      ...
      // Save locally as fallback if DB fails
      setResponses(prev=>[...prev,{
  ...
  const tryLogin = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setDbError("Could not load responses from database.");
      }
    } catch(e) {
      setDbError("Database connection error: "+e.message);
    }
    setLoadingDB(false);
...
{"presentationTitle":"Asia Pacific Survey Results","slides":[{"category":"OVERVIEW","icon":"🌏","title":"...","points":["...","...","..."]},{"category":"Q1 INSIGHTS","icon":"...","title":"...","points":["...","...","..."]}]}
          ...
          <div style={{maxWidth:"720px",width:"100%"}}>
            <div style={{textAlign:"center",marginBottom:"44px"}}>
              ...
              <h1 style={{fontSize:"38px",fontWeight:"800",lineHeight:"1.1"}}>
                Share Your <span style={{color:G}}>Voice</span>
              </h1>
              <p style={{marginTop:"10px",color:"#7aaa88",fontSize:"14px"}}>
                Select your language · 选择语言 · 言語を選択
              </p>
            </div>
